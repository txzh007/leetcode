...
void myQueuePush(MyQueue *obj, int x) {
  obj->data[obj->right] = x;
  obj->right++;
}

/** Removes the element from in front of queue and returns that element. */
int myQueuePop(MyQueue *obj) { return obj->data[obj->left++]; }

/** Get the front element. */
int myQueuePeek(MyQueue *obj) { return obj->data[obj->left]; }

/** Returns whether the queue is empty. */
bool myQueueEmpty(MyQueue *obj) { return obj->left == obj->right; }
